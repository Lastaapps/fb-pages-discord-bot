...
class DateTimeUtilsKtTest : StringSpec(
    {
        ...
        "parseFacebookTime" {
            ...
            forAll(
                row(UTC, "Just now", LocalDateTime(2024, Month.JUNE, 19, 16, 42)),
                row(UTC, "1 min", LocalDateTime(2024, Month.JUNE, 19, 16, 41)),
                row(UTC, "18 mins", LocalDateTime(2024, Month.JUNE, 19, 16, 24)),
                row(UTC, "1 hr", LocalDateTime(2024, Month.JUNE, 19, 15, 0)),
                row(UTC, "18 hrs", LocalDateTime(2024, Month.JUNE, 18, 22, 0)),
                ...
                row(gmt1, "Just now", LocalDateTime(2024, Month.JUNE, 19, 16, 42)),
                row(gmt1, "1 min", LocalDateTime(2024, Month.JUNE, 19, 16, 41)),
                row(gmt1, "18 mins", LocalDateTime(2024, Month.JUNE, 19, 16, 24)),
                row(gmt1, "1 hr", LocalDateTime(2024, Month.JUNE, 19, 15, 0)),
                row(gmt1, "18 hrs", LocalDateTime(2024, Month.JUNE, 18, 22, 0)),
