    ...
    StringSpec(
        {
            ...
            "post_with_instagram_link" {
                ...
                FacebookPostParser.parsePost(body, pageIdSH, postId, CET).also(::println) shouldBe
                    Post(
                        id = postId,
                        pageId = pageIdSH,
                        publishedAt = LocalDateTime(2024, 5, 5, 10, 43).toInstant(UTC),
                        ...
                        images =
                            listOf(
                                "https://scontent-prg1-1.cdninstagram.com/v/t51.29350-15/441730885_335831969166368_4043422195989950892_n.webp?stp=dst-jpg&_nc_cat=104&ccb=1-7&_nc_sid=18de74&_nc_ohc=jv_Wgs4RUUcQ7kNvgGGUE-s&_nc_ht=scontent-prg1-1.cdninstagram.com&oh=00_AYCPoNTT76siOHc1hSsEVzjmSVdiYQf3tDpVdtd51k4TrA&oe=6677DDD9",
                            ),
            ...
            "post_with_event" {
                ...
                FacebookPostParser.parsePost(body, pageIdSH, postId, CET).also(::println) shouldBe
                    Post(
                        ...
                        author = "Silicon Hill",
                        description = "Už dnes se budou konat další blokové hry. Přijďte se k nám připojit v 20:00 před Blokem 8 na naši další vzrušující hru blokových her Vesmírné Podnikání💸!\nPřijít může každý, ať už jsi na hrách nikdy nebyl nebo jsi ostřílený veterán. Rádi vás tam všechny uvidíme 😁 Navíc byla vyhlášená další Bonusová hra, které se můžete zúčastnit již tento čtvrtek 2.5. od 5:30 mezi bloky 4 a 8. Více info: https://wiki.sh.cvut.cz/klub/blokove_hry/ls_2024",
                        images = listOf(),
            ...
            "event" {
                ...
                FacebookEventParser.parseEvent(body, eventId).also(::println) shouldBe
                    Event(
                        id = eventId,
                        img = "https://scontent-prg1-1.xx.fbcdn.net/v/t39.30808-6/438096988_822475816590884_3419053407703239443_n.png?stp=cp0_dst-jpg_e15_fr_q65&_nc_cat=101&ccb=1-7&_nc_sid=5f2048&efg=eyJpIjoiYiJ9&_nc_ohc=-3VEZxwwewwQ7kNvgGIJzLm&_nc_ht=scontent-prg1-1.xx&oh=00_AYD0L2_HPnFnBFL_nE8rHPCd5M8HrOiQFtjeW7C2C5mdgA&oe=6677D489",
