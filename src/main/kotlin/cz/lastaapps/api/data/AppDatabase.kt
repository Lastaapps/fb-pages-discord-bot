...
@JvmInline
value class AppDatabase(val database: Database) {
    companion object Factory {
        ...
        private val fbPageIDAdapter = object : ColumnAdapter<FBPageID, Long> {
        ...
        private val dbPageIDAdapter = object : ColumnAdapter<DBPageID, Long> {
        ...
        private val dbChannelIDAdapter = object : ColumnAdapter<DBChannelID, Long> {
        ...
        private val dcChannelIDAdapter = object : ColumnAdapter<DCChannelID, Long> {
        ...
        private val dbPageTokenIDAdapter = object : ColumnAdapter<DBPageTokenID, Long> {
        ...
        private val fbPostIdAdapter = object : ColumnAdapter<FBPostID, String> {
        ...
        private val dcMessageIDAdapter = object : ColumnAdapter<DCMessageID, Long> {
        ...
        private val pageAccessTokenAdapter = object : ColumnAdapter<PageAccessToken, String> {
        ...
        private fun createDatabase(driver: SqlDriver): Database = Database(
            ...
            Posted_PostAdapter = Posted_Post.Adapter(
                channel_idAdapter = dbChannelIDAdapter,
